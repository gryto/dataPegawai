...
class PerkaraNamaPage extends StatefulWidget {
  const PerkaraNamaPage({super.key});

  @override
  State<PerkaraNamaPage> createState() => _PerkaraNamaPageState();
}

class _PerkaraNamaPageState extends State<PerkaraNamaPage> {
          ...
          children: [
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                hintText: 'Masukkan Nama Tersangka ',
                label: Row(
                  children: [
                    Text(
              ...
              validator: (value) {
                if (value == null || value.isEmpty) {
                  return 'Pilih Nama Tersangka Terlebih Dahulu!';
                }
                return null;
              },
              onTap: () async {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Padding(
                          ...
                          child: Text(
                            "Masukka Data Nama Tersangka yang terkait dengan perkara",
                            style: TextStyle(
                            ...
                            onTap: () {
                              if (_formKey.currentState!.validate()) {
                                Navigator.of(context).push(
                                  MaterialPageRoute(
                                    builder: (context) => ListPerkaraNama(
                                      namaTersangka: ctrlTanggal.text.toString(),
